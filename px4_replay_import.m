...
% Specify column names and types
opts.VariableNames = ["timestamp", "timestamp_sample", "baro_device_id", "baro_alt_meter", "baro_temp_celcius", "baro_pressure_pa", "rho"];
...
% Convert to output type
timestamp_baro = tbl.timestamp_sample;
...
% Specify column names and types
opts.VariableNames = ["timestamp", "timestamp_sample", "device_id", "magnetometer_ga0", "magnetometer_ga1", "magnetometer_ga2"];
...
% Convert to output type
timestamp_mag = tbl.timestamp_sample;
